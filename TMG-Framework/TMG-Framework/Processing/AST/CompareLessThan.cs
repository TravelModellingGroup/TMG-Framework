        ...
        public override ComputationResult Evaluate(ComputationResult lhs, ComputationResult rhs)
        {
            ...
            if (lhs.IsValue)
            {
                if (rhs.IsVectorResult)
                {
                    ...
                    VectorHelper.FlagIfLessThan(flat, lhs.LiteralValue, rhs.VectorData.Data);
                ...
                else
                {
                    ...
                    VectorHelper.FlagIfLessThan(retMatrix.Data, lhs.LiteralValue, rhs.OdData.Data);
            ...
            else if (rhs.IsValue)
            {
                if (lhs.IsVectorResult)
                {
                    ...
                    var flat = retVector.Data;
                    VectorHelper.FlagIfLessThan(flat, lhs.VectorData.Data, rhs.LiteralValue);
                ...
                else
                {
                    ...
                    VectorHelper.FlagIfLessThan(retMatrix.Data, lhs.OdData.Data, rhs.LiteralValue);
                    return new ComputationResult(retMatrix, true);
                }
            }
            else
            {
                if (lhs.IsVectorResult || rhs.IsVectorResult)
                {
                    if (lhs.IsVectorResult && rhs.IsVectorResult)
                    {
                        ...
                        VectorHelper.FlagIfLessThan(retMatrix.Data, 0, lhs.VectorData.Data, 0, rhs.VectorData.Data, 0, retMatrix.Data.Length);
                ...
                else
                {
                    ...
                    VectorHelper.FlagIfLessThan(retMatrix.Data, 0, lhs.OdData.Data, 0, rhs.OdData.Data, 0, lhs.OdData.Data.Length);
                    return new ComputationResult(retMatrix, true);
                }
            }
        }
