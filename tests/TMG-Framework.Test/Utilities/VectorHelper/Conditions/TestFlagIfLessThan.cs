...
[TestClass]
public class TestFlagIfLessThan
{
    [TestMethod]
    public void FlagLessThanVectorScalar()
    {
        ...
        TMG.Utilities.VectorHelper.FlagIfLessThan(dest, value, data);
    ...
    [TestMethod]
    public void FlagLessThanVectorScalarWrongSize()
    {
    ...
    [TestMethod]
    public void FlagLessThanVectorVector()
    {
        Span<float> dest = stackalloc float[100];
        Span<float> data = stackalloc float[100];
    ...
    [TestMethod]
    public void FlagLessThanVectorVectorWrongSize()
    {
