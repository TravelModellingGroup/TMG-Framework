...
[TestClass]
public class TestFlagIfEquals
{
    [TestMethod]
    public void FlagEqualsVectorScalar()
    {
        ...
        TMG.Utilities.VectorHelper.FlagIfEquals(dest, value, data);
    ...
    [TestMethod]
    public void FlagEqualsVectorScalarWrongSize()
    {
    ...
    [TestMethod]
    public void FlagEqualsVectorVector()
    {
        Span<float> dest = stackalloc float[100];
        Span<float> data = stackalloc float[100];
    ...
    [TestMethod]
    public void FlagEqualsVectorVectorWrongSize()
    {
