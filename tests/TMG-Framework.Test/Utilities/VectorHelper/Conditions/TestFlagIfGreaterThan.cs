...
[TestClass]
public class TestFlagIfGreaterThan
{
    [TestMethod]
    public void FlagGreaterThanVectorScalar()
    {
        ...
        TMG.Utilities.VectorHelper.FlagIfGreaterThan(dest, value, data);
    ...
    [TestMethod]
    public void FlagGreaterThanVectorScalarWrongSize()
    {
    ...
    [TestMethod]
    public void FlagGreaterThanVectorVector()
    {
        Span<float> dest = stackalloc float[100];
        Span<float> data = stackalloc float[100];
    ...
    [TestMethod]
    public void FlagGreaterThanVectorVectorWrongSize()
    {
