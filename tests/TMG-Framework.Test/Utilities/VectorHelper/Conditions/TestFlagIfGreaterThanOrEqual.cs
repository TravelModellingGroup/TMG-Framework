...
[TestClass]
public class TestFlagIfGreaterThanOrEqual
{
    [TestMethod]
    public void FlagGreaterThanOrEqualVectorScalar()
    {
        ...
        TMG.Utilities.VectorHelper.FlagIfGreaterThanOrEqual(dest, value, data);
    ...
    [TestMethod]
    public void FlagGreaterThanOrEqualVectorScalarWrongSize()
    {
    ...
    [TestMethod]
    public void FlagGreaterThanOrEqualVectorVector()
    {
        Span<float> dest = stackalloc float[100];
        Span<float> data = stackalloc float[100];
    ...
    [TestMethod]
    public void FlagGreaterThanOrEqualVectorVectorWrongSize()
    {
