...
[TestClass]
public class TestFlagAnd
{
    [TestMethod]
    public void FlagAndVectorScalar()
    {
        ...
        TMG.Utilities.VectorHelper.FlagAnd(dest, value, data);
    ...
    [TestMethod]
    public void FlagAndVectorScalarWrongSize()
    {
    ...
    [TestMethod]
    public void FlagAndVectorScalarZero()
    {
        Span<float> dest = stackalloc float[100];
        Span<float> data = stackalloc float[100];
        var value = 0f;        
    ...
    [TestMethod]
    public void FlagAndVectorVector()
    {
        Span<float> dest = stackalloc float[100];
        Span<float> data = stackalloc float[100];
    ...
    [TestMethod]
    public void FlagAndVectorVectorWrongSize()
    {
